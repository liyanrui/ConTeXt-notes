...
\mysample[starting-area]{新手村}{starting-area.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[true-words]{两行真实文字}{true-words.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[fakewords]{两行伪文字}{fakewords.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[lines]{排版多行文本}{lines.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[pars-2]{多行文本构成的段落}{pars-2.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[pars-3]{设置段落首行缩进}{pars-3.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[parindentcolor]{消除段落缩进色块}{parindentcolor.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[noindent]{消除第二段的首行缩进}{pars-4.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[pars-5]{多行文本构成的段落}{pars-5.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[aligned-1]{多行文本构成的段落}{aligned-1.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[aligned-2]{段落对齐}{aligned-2.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[letter]{一封谁也看不懂的信}{letter.pdf}
