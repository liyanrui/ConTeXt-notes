...
\stopTEXpage
\stopsample
\sample[TEX][starting-area]{新手村}{\externalfigure[02/starting-area.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][true-words]{两行真实文字}{\externalfigure[02/true-words.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][fakewords]{两行伪文字}{\externalfigure[02/fakewords.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][lines]{排版多行文本}{\externalfigure[02/lines.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][pars]{分段}{\externalfigure[02/pars.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][pars-2]{多行文本构成的段落}{\externalfigure[02/pars-2.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][pars-3]{设置段落首行缩进}{\externalfigure[02/pars-3.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][parindentcolor]{消除段落缩进色块}{\externalfigure[02/parindentcolor.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][noindent]{消除第二段的首行缩进}{\externalfigure[02/pars-4.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][pars-5]{多行文本构成的段落}{\externalfigure[02/pars-5.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][aligned-1]{多行文本构成的段落}{\externalfigure[02/aligned-1.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][aligned-2]{段落对齐}{\externalfigure[02/aligned-2.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][letter]{一封谁也看不懂的信}{\externalfigure[02/letter.pdf][width=.425\textwidth]}
