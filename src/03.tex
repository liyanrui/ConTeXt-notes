...
\stopTEXpage
\stopsample
\sample[hello-hanzi]{三种汉字字体}{\externalfigure[03/qian.pdf]}
...
\stopTEXpage
\stopsample
\sample[无法断行]{中文段落无法断行}{\externalfigure[03/breakinglines-1.pdf]}
...
\stopTEXpage
\stopsample
\sample[将错就错]{中文段落无法断行}{\externalfigure[03/breakinglines-2.pdf]}
...
\stopTEXpage
\stopsample
\sample[手工断行]{中文段落手工插入空格进行断行}{\externalfigure[03/breakinglines-3.pdf]}
...
\stopTEXpage
\stopsample
\sample[手工插入粘连断行]{中文段落手工插入粘连进行断行}{\externalfigure[03/breakinglines-4.pdf]}
...
\stopTEXpage
\stopsample
\sample[孙悟空的信]{孙悟空的信}{\externalfigure[03/breakinglines-5.pdf]}
...
\stopformula
\stopsample
\sample[默认字体]{\ConTeXt\ 默认字体}{\externalfigure[03/defaultfonts.pdf]}
...
{\tfa A} {\tfb A} {\tfc A} {\tfd A}
\stopsample
\sample[fontsize-level]{字体大小的 7 种级别}{\externalfigure[03/fontsize-level.pdf]}
...
虽然我很少写信，其实我很怀念花果山。
\stopsample
\sample[em-1]{段落缩进距离是 24 pt}{\externalfigure[03/indenting-1.pdf]}
...
虽然我很少写信，其实我很怀念花果山。
\stopsample
\sample[em-2]{段落缩进距离是 18 pt}{\externalfigure[03/indenting-2.pdf]}
...
\stopTEXpage
\stopsample
\sample[setupbodyfont]{定义正文字体并启用}{\externalfigure[03/setupbodyfont.pdf]}
...
\stopTEXpage
\stopsample
\sample[fallbacks]{字形替换}{\externalfigure[03/fallbacks.pdf]}
