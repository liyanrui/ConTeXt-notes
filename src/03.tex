...
\mysample[hello-hanzi]{三种汉字字体}{03/qian.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[无法断行]{中文段落无法断行}{03/breakinglines-1.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[将错就错]{中文段落无法断行}{03/breakinglines-2.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[手工断行]{中文段落手工插入空格进行断行}{03/breakinglines-3.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[手工插入粘连断行]{中文段落手工插入粘连进行断行}{03/breakinglines-4.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[孙悟空的信]{孙悟空的信}{03/breakinglines-5.pdf}
...
\stopformula
\stopnarrowtyping\stopsamplecode
\mysample[默认字体]{\ConTeXt\ 默认字体}{03/defaultfonts.pdf}
...
{\tfa A} {\tfb A} {\tfc A} {\tfd A}
\stopnarrowtyping\stopsamplecode
\mysample[fontsize-level]{字体大小的 7 种级别}{03/fontsize-level.pdf}
...
虽然我很少写信，其实我很怀念花果山。
\stopnarrowtyping\stopsamplecode
\mysample[em-1]{段落缩进距离是 24 pt}{03/indenting-1.pdf}
...
虽然我很少写信，其实我很怀念花果山。
\stopnarrowtyping\stopsamplecode
\mysample[em-2]{段落缩进距离是 18 pt}{03/indenting-2.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[setupbodyfont]{定义正文字体并启用}{03/setupbodyfont.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[fallbacks]{字形替换}{03/fallbacks.pdf}
