...
\stopTEXpage
\stopsample
\sample[TEX][zaoshu]{散文示例 1}{\externalfigure[04/zaoshu.pdf]}
...
\stopTEXpage
\stopsample
\sample[TEX][zaoshu-2]{散文示例 2}{\externalfigure[04/zaoshu-2.pdf]}
...
% 省略了正文内容
\stopsample
\sample[TEX][zaoshu-3]{散文示例 3}{\externalfigure[04/zaoshu-3.pdf]}
...
% 省略了正文内容
\stopsample
\sample[TEX][zaoshu-4]{散文示例 4}{\externalfigure[04/zaoshu-4.pdf]}
...
% 省略了正文内容
\stopsample
\sample[TEX][zaoshu-5]{散文示例 5}{\externalfigure[04/zaoshu-5.pdf]}
