...
\mysample[zaoshu]{散文示例 1}{04/zaoshu.pdf}
...
\stopTEXpage
\stopnarrowtyping\stopsamplecode
\mysample[zaoshu-2]{散文示例 2}{04/zaoshu-2.pdf}
...
% 省略了正文内容
\stopnarrowtyping\stopsamplecode
\mysample[zaoshu-3]{散文示例 3}{04/zaoshu-3.pdf}
...
% 省略了正文内容
\stopnarrowtyping\stopsamplecode
\mysample[zaoshu-4]{散文示例 4}{04/zaoshu-4.pdf}
...
% 省略了正文内容
\stopnarrowtyping\stopsamplecode
\mysample[zaoshu-5]{散文示例 5}{04/zaoshu-5.pdf}
