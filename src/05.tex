...
\stopitemize
\stopsample
\sample[todo-list]{待办事项}{\externalfigure[05/todo-list.pdf]}
...
\stopitemize
\stopsample
\sample[]{改变列表项符号}{\externalfigure[05/todo-list-2.pdf]}
...
\stopitemize
\stopsample
\sample[]{有序号列表}{\externalfigure[05/todo-list-3.pdf]}
...
\stopitemize
\stopsample
\sample[]{数字带括号的有序号列表}{\externalfigure[05/todo-list-4.pdf]}
...
\stopitemize
\stopsample
\sample[rsquare]{自定义符号的无序号列表}{\externalfigure[05/todo-list-5.pdf]}
...
\stopitemize
\stopsample
\sample[number-in-circle]{数字带圆圈的有序号列表}{\externalfigure[05/todo-list-6.pdf]}
...
\stopitemize
\stopsample
\sample[]{消除列表项之间的空白}{\externalfigure[05/todo-list-7.pdf]}
...
\stopitemize
\stopsample
\sample[]{消除列表项之间的空白}{\externalfigure[05/todo-list-8.pdf]}
