...
\noindent 便可将 ctxnotes.png 作为插图，即 \externalfigure[ctxnotes.png]。显然，这是插图，但很可能并非是我们想要的插图形式。我们想要的是，独占一行且居中放置的插图，这个要求这并不难实现：
...
\stoptyping
\midaligned{\externalfigure[hibert.pdf]}
...
\stoptyping
\midaligned{\externalfigure[hibert-1.pdf]}
...
\stoptyping
\midaligned{\externalfigure[hibert-2.pdf]}
...
\stoptyping
\midaligned{\blueframed{\externalfigure[hibert-3.pdf]}}
...
\stoptyping
\leftaligned{\externalfigure[05-floatcomb.pdf]}
...
\stoptyping
\midaligned{\externalfigure[05-floatcomb-2.pdf]}
...
\stoptyping
\midaligned{\externalfigure[05-floatcomb-3.pdf]}
...
\stoptyping
\midaligned{\externalfigure[05-floatcomb-4.pdf]}
...
\stoptyping
\midaligned{\externalfigure[05-metapost.pdf]}
