...
关于 \MetaPost\ 更为深入和全面的介绍，可参考其手册\cite[mpman] 以及 Hans Hagen 所写的 \METAFUN\ 手册，后者已在你所安装的 \CONTEXT\ 系统中了，使用以下命令可以找到它。

\starttyping
$ mtxrun --search metafun-p.pdf
\stoptyping

另外，由 Hans Hagen 主持且尚在开发中的 LuaMetaFun 项目可谓是下一代 \METAPOST，关于该项目的一些进展和成果，见
