...
\placefigure[here][processbar]{第 3 页幻灯片}{\externalfigure[12/slides.pdf][width=.6\textwidth,page=4,frame=on]}
...
\placefigure[here][slide-background]{浅灰色背景}{\externalfigure[12/slides-finished.pdf][width=.6\textwidth,page=1,frame=on]}
