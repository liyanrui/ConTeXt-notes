...
制作幻灯片通常不需要太大的纸面尺寸。\ConTeXt\ 提供了 S4 尺寸（$400\,{\rm pt}\times 300\,{\rm pt}$），可将其作为幻灯片的纸面尺寸。
...
\stoptext
\stoptyping
\midaligned{\externalfigure[12-slides-1.pdf][width=\textwidth,frame=on]}
...
\placefigure[here][12-layout-1]{\ConTeXt\ 默认的页面布局}{\externalfigure[12-layout-1.pdf][width=\textwidth]}

\placefigure[here][ConTeXt-layout]{页面布局注解}{\externalfigure[ConTeXt-layout.svg][width=.8\textwidth]}
...
\stoptext
\stoptyping
\midaligned{\externalfigure[12-slides-2.pdf][width=\textwidth,frame=on]}
...
\stoptyping
\midaligned{\externalfigure[12-slides-3.pdf][width=\textwidth,frame=on]}
\blank
...
\placefigure[here][页码进度]{第 4 页幻灯片}{\externalfigure[12-slides-4.pdf][page=4,width=\textwidth,frame=on]}
...
\placefigure[here][processbar]{第 3 页幻灯片}{\externalfigure[slides.pdf][width=\textwidth,page=4,frame=on]}
...
\placefigure[here][cover]{封面}{\externalfigure[slides.pdf][width=\textwidth,page=1,frame=on]}
...
使用 \type{standardmakeup} 的好处是，它没有页眉和页脚，而且页面无页码，且独立于 \ConTeXt\ 的页码计数器。
...
\stoptyping
\placefigure[here,none][]{}{\externalfigure[slides-finished.pdf][width=\textwidth,page=1,frame=on]}
