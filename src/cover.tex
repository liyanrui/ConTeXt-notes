...
draw p yscaled(OverlayHeight / OverlayWidth) withcolor \MPcolor{tan}; %transparent(1, .5, darkgray); %\MPcolor{tan};
\stopuseMPgraphic
...
fill p withcolor transparent(1, .375, \MPcolor{dimgray});
