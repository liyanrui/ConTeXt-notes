...
基于第 \in[chinese-fonts] 章介绍的汉字字体的设定方法，使用 \CONTEXT\ 足以排版中文文档，但是存在汉字标点符号的间距过大且无法与正文左右边界对齐等问题。若你对此无法忍受，可以考虑使用我写的 zhfonts 模块。
...
\placefigure[here][none-zhfonts]{未使用 zhfonts 的中文标点排版效果}{%
  \clip[width=\textwidth,height=5cm,voffset=1.8cm]{\externalfigure[none-zhfonts.pdf][width=\textwidth]}}
\placefigure[here][zhfonts]{使用 zhfonts 的中文标点排版结果}{%
  \clip[width=\textwidth,height=4.25cm,voffset=1.8cm]{\externalfigure[zhfonts.pdf][width=\textwidth]}}

\section{安装 zhfonts 模块}
